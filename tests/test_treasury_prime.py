            ...
            "data": [
                {
                    ...
                    "bankdata": None,
                    "phone_number": "+1 925-555-5555",
                    "mailing_address": None,
                    "occupation": None,
                    "physical_address": {
                        "street_line_1": "215 Kearny St",
                        "street_line_2": None,
                        "city": "San Francisco",
                        "state": "CA",
                        "postal_code": "94102",
                    ...
                    "person_id": "psn_11grbtpc6e5jwp",
                    "middle_name": None,
                    "updated_at": "2021-11-06T02:39:08Z",
                    "gov_id": None,
                    "document_ids": [],
                    "id": "apsn_11grbtp76e5jqm",
                    "citizenship": "US",
                    "date_of_birth": "2000-01-01",
                    "last_name": "dubno",
                    "user_id": None,
                    "email_address": "olehdubno@gmail.com",
                    "created_at": "2021-11-06T02:39:03Z",
                    "userdata": None,
                }
            ],
            "total_estimated": 10,
...
def mock_get_account_low_available_balance():
    return Mock(
        return_value={
            ...
            "bank_id": "bank_treasuryprime",
            "person_ids": ["psn_11grbtpc6e5jwp"],
            "available_balance": "1.00",
            "name": "oleh dubno",
            "org_id": "org_1fkshrk60m4",
            "updated_at": "2022-01-07T04:00:23Z",
            "currency": "USD",
            "routing_number": "000000000",
            "status": "open",
            "primary_person_id": "psn_11grbtpc6e5jwp",
            "account_number": "137000477144",
            "locked": False,
            "id": "acct_1",
            "funded": True,
            "business_ids": [],
            "current_balance": "1.00",
            "created_at": "2021-11-06T02:39:08Z",
            "lock": None,
            "userdata": None,
        }
    )
...
@patch(
    "treasury_prime.treasury_prime.book_transfer_request", mock_book_transfer_request()
)
@patch(
    "treasury_prime.treasury_prime.get_account",
    mock_get_account_high_available_balance(),
)
...
@patch(
    "treasury_prime.treasury_prime.get_account",
    mock_get_account_low_available_balance(),
)
...
@patch(
    "treasury_prime.models.apply.create_person_application",
    mock_create_person_application(),
)
